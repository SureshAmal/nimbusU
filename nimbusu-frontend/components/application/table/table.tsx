...
const TableRowInner = forwardRef(
  <T extends object>(
    {
      columns,
      children,
      ...
      onContextMenu,
      ...props
    }: TableRowProps<T> & { onContextMenu?: (e: React.MouseEvent) => void },
...
const TableRow = TableRowInner as <T extends object>(
  props: TableRowProps<T> & { ref?: Ref<HTMLTableRowElement> },
) => ReactElement;
